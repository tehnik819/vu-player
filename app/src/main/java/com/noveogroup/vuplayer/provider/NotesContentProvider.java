...
public class NotesContentProvider extends ContentProvider {
    ...
    private static final String LOG_TAG = NotesContentProvider.class.getSimpleName();
    ...
    public Uri insert(Uri uri, ContentValues contentValues) {
        ...
        if (TextUtils.equals(tableName, ContentDescriptor.Notes.TABLE_NAME)) {
            return Uri.parse(ContentDescriptor.Notes.TABLE_URI + "/" + id);
        } else {
            return null;
        }
    }
